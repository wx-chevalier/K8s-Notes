...
![userspace代理模式下Service概览图](https://assets.ng-tech.icu/book/kubernetes-handbook/services-userspace-overview.jpg "userspace代理模式下Service概览图")
...
![iptables代理模式下Service概览图](https://assets.ng-tech.icu/book/kubernetes-handbook/services-iptables-overview.jpg "iptables代理模式下Service概览图")
...
![ipvs代理模式下Service概览图](https://assets.ng-tech.icu/book/kubernetes-handbook/service-ipvs-overview.png "ipvs代理模式下Service概览图")
