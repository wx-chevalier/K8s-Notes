...
![test-infra架构图（图片来自官方GitHub）](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/kubernetes-test-architecture.jpg "test-infra架构图（图片来自官方GitHub）")
