...
![Kubernetes 集群联邦架构图](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/federation-concepts.png "Kubernetes 集群联邦架构图")
...
![KubeFed 基础架构](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/sync-controller.png "KubeFed 基础架构")
...
![RSP](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/kubefed-rsp.png "RSP")
...
![DNS](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/kubefed-service-dns.png "DNS")
