...
![Kubernetes Gateway API 简介](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/gateway-api.svg)
...
![Gateway 管理中的角色划分（图片来自：https://gateway-api.sigs.k8s.io/）](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/gateway-roles.png)
...
![流量经过网关和 HTTPRoute 到服务中的过程](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/httproute-basic-example.svg)
...
![路由绑定示意图](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/gateway-api-route-binding.jpg "路由绑定示意图")
...
![Gateway API 的默认值和覆盖值的优先层级](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/policy-attachment-level.svg)
...
![Gateway API 流程图](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/gateway-api-request-flow.png "Gateway API 流程图")
...
![客户端/服务器和 TLS](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/kubernetes-handbook/tls-overview.svg)
